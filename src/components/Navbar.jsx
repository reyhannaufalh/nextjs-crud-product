          ...
          <div className="flex items-center gap-2">
            {!loading && !user ? (
              <>
                <Link
                  href="/login"
                  className="px-4 py-2 font-semibold text-white rounded-md bg-primary-500"
                >
                  Login
                </Link>
                <Link
                  href="/register"
                  className="px-4 py-2 font-semibold rounded-md bg-neutral-100"
                >
                  Register
                </Link>
              </>
              ...
              <>
                ...
                <div className="relative flex items-center ms-3">
                  ...
                  {dropdownUser && (
                    <div
                      className="absolute right-0 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 top-12"
                      id="dropdown-user"
                    >
