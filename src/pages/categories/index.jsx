...
import { useDeleteCategory, useFetchCategories } from "@/features/category";
...
export default function Index() {
  ...
  const { mutate: deleteCategory, isLoading: deleteIsLoading } =
    useDeleteCategory({
      onSuccess: () => {
        refetchCategories();
      },
  ...
  return (
    <DashboardLayout>
      <h1 className="mb-10 text-3xl font-semibold">Categories Management</h1>
